...
\begin{center}
\includegraphics[width=0.8\textwidth,height=\textheight]{~/Documents/Figures/p-Hacking-example.png}
\end{center}
\end{frame}
...
\begin{center}
\includegraphics[width=0.8\textwidth,height=\textheight]{~/Documents/Figures/p-Hacking-table.png}
\end{center}
\end{frame}
...
\begin{center}
\includegraphics[width=0.7\textwidth,height=\textheight]{~/Documents/Figures/publish-perish-comic.jpeg}
\end{center}
\end{frame}
...
\begin{center}
\includegraphics[width=0.5\textwidth,height=\textheight]{~/Documents/Figures/avoiding-qrp.png}
\end{center}
\end{frame}
...
\begin{center}
\includegraphics[width=0.8\textwidth,height=\textheight]{~/Documents/Figures/paid-os.png}
\end{center}
\end{frame}
...
\begin{center}
\includegraphics[width=0.8\textwidth,height=\textheight]{~/Documents/Figures/cos-intro.png}
\end{center}
\end{frame}
...
\begin{center}
\includegraphics{~/Documents/Figures/osf-wiki.png}
\end{center}
\end{frame}
...
\begin{center}
\includegraphics{~/Documents/Figures/linkedin-predatory-duplicate.jpg}
\end{center}
\end{frame}
...
\begin{center}
\includegraphics{~/Documents/Figures/retractions-twitter.png}
\end{center}
\end{frame}
