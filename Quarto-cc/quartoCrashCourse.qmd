...
::: incremental
-   For a brief start-up, copy the provided code and paste it in the current open `.qmd` and hit render.
...
Now that we know basics of documentation, version control and remote repos (I know, we are yet to demonstrate this), blogging is extremely easy with Quarto.
...
## Needed for blogging {background-color="#346bc8"}

Important steps for using remote repo are:

1.  Git *This may or may not work.* The code is available in the code.text file.
2.  GitHub account
...
-   Workflow is executable... why is this important?
