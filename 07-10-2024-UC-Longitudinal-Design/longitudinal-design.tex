...
\begin{center}
\includegraphics{~/Documents/GitHub/talks/figs/iq-example-long-design.jpg}
\end{center}
\end{frame}
...
\includegraphics{~/Documents/GitHub/talks/figs/mds-sponsors.png}
\end{frame}
...
\begin{frame}
\includegraphics{~/Documents/GitHub/talks/figs/nzavs-alluvial.png}
\end{frame}
...
\includegraphics[width=0.85\textwidth,height=\textheight]{~/Documents/GitHub/talks/figs/boxplots-warmth-groups.png}
\end{frame}

\begin{frame}{Overtime Change in Warth Towards Muslims}
\phantomsection\label{overtime-change-in-warth-towards-muslims}
\includegraphics[width=0.85\textwidth,height=\textheight]{~/Documents/GitHub/talks/figs/discontinuity_plot_warm_muslims_2024.png}
\end{frame}

\begin{frame}{Tracking Changes Overtime}
\phantomsection\label{tracking-changes-overtime}
\includegraphics{~/Documents/GitHub/talks/figs/individual-warmth-trajectory.png}
\end{frame}
