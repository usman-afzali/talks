...
::: {layout="[[1], [1,1,1]]"}
![](figs/mds.png){width="60%" fig-align="center"} ![](figs/sponsors.png)
:::
...
::: incremental
-   Allocated more points to members of their own group than to members
    of the other group.
...
-   Examples: Religious fervor, racial and ethnic conceit, aggressive
    nationalism, even gossiping [@bosson2006; @weaver2011]
...
::: incremental
-   Married couples have high wellbeing (emotional and psych) and
    physical
...
:::{layout-nrow=2}
![](figs/usman-a.jpeg){width=1in}

![](figs/joe-b.jpg){width=1in}
![](figs/chris-s.png){width=1in}


![](figs/kumar-y.jpg){width=1in}

![](figs/aarif-r.jpeg){width=1in}
