...
\begin{center}
\includegraphics[width=0.8\linewidth,height=\textheight,keepaspectratio]{~/Documents/Figures/p-Hacking-example.png}
\end{center}
\end{frame}
...
\begin{center}
\includegraphics[width=0.8\linewidth,height=\textheight,keepaspectratio]{~/Documents/Figures/p-Hacking-table.png}
\end{center}
\end{frame}
...
\begin{center}
\includegraphics[width=0.7\linewidth,height=\textheight,keepaspectratio]{~/Documents/Figures/publish-perish-comic.jpeg}
\end{center}
\end{frame}
...
\begin{center}
\includegraphics[width=0.5\linewidth,height=\textheight,keepaspectratio]{~/Documents/Figures/avoiding-qrp.png}
\end{center}
\end{frame}
...
\begin{center}
\includegraphics[width=0.8\linewidth,height=\textheight,keepaspectratio]{~/Documents/Figures/paid-os.png}
\end{center}
\end{frame}
...
\begin{center}
\includegraphics[width=0.8\linewidth,height=\textheight,keepaspectratio]{~/Documents/Figures/cos-intro.png}
\end{center}
\end{frame}
...
\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{~/Documents/Figures/osf-wiki.png}}
\end{center}
\end{frame}
...
\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{~/Documents/Figures/linkedin-predatory-duplicate.jpg}}
\end{center}
\end{frame}
...
\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{~/Documents/Figures/retractions-twitter.png}}
\end{center}
\end{frame}
