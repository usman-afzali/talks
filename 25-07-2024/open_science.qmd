...
![](figs/p-Hacking.png){fig-align="center"}
------------------------------------------------------------------------
...
![](figs/p-Hacking-table.png){fig-align="center"}
------------------------------------------------------------------------
...
-   Career advancement
-   Research funding
-   Some examples: p-Hacking, HARKing, selective reporting, data fabrication/falsification, inadequate reporting of methods and procedures, publication bias, overinterpreation of results
...
-   Do we need to look further into Muslim lives, in a more objective
    way?
...
-   Will attending mosque more, prevent us from feeling of
    discrimination?
-   Do we face more challenges to employment and health service than
    other groups?
:::
...
3.  Subjective well-being, the meaning of life, and psychological
